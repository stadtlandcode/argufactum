(function(q) {
	q.model = {
		...
		questions: [
			...
			{
				number: 5,
				text: 'Halten Sie die Mehrkosten für den Erhalt der Realschule RBS für vertretbar?',
				supports: 'YES',
				facts: [{
					number: 1,
					references: [],
			...
			{
				number: 6,
				text: 'Sind Sie dafür, dass die Stadt weitere Optionen als die Auflösung der Realschule RBS prüfen muss?',
				supports: 'YES',
				facts: [{
					number: 1,
					references: [],
			...
			{
				number: 7,
				text: 'Halten Sie die Realschule RBS für besonders erhaltenswert?',
				supports: 'YES',
				facts: [
					{
						number: 1,
