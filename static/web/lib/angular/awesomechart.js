angular.module('AwesomeChartJS', []).directive('awesomechart', function() {
	return {
		...
		link: function(scope, element, attrs) {
			...
			// TODO: it is not cool that AwesomeChart can work with ids only :-(
			// consider sending a pull request for this / or just fork since it
			// is also messing with Array''s prototype
			// TODO: other pb with the lib is that is messing up with the
			// Array.prototype and is in global scope
			...
			var redraw = function(newScopeData) {
				...
				// clear it up first: not the nicest method (should be a call on
				// AwesomeChart) but no other choice here...
