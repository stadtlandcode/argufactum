...
<head>
	...
	<title><spring:message code="myTopics.title" /> - <spring:message code="applicationName" /></title>
</head>
<body>
<div class="container">
	...
	<div id="content">
		...
		<div class="page-header">
			<h1><spring:message code="myTopics.title" /></h1>
		</div>
		
		<div class="row">
			<tags:topicList topics="${allTopics}" boxClass="span9" />
		</div>
	</div>
